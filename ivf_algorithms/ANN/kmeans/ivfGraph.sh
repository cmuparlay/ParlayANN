...
P=/ssd1/data/bigann
./ivf -base_path $P/base.1B.u8bin.crop_nb_10000000 -query_path $P/query.public.10K.u8bin -cluster_outfile $P/kmeans_graph_10M_10000 -res_path bigann_ivf_comp_10M.csv -gt_path $P/bigann-10M -data_type uint8 -num_clusters 100 -dist_func Euclidian -k 10
