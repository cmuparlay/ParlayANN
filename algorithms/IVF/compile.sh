...
g++ -DSTATS -DHOMEGROWN -pthread -mcx16 -O0 -g -Wall -std=c++17 -march=native -I . -fPIC $(python3 -m pybind11 --includes) ivf_test.cpp -o ivf_test -DHOMEGROWN -pthread -ldl -L/usr/local/lib -I ../../parlaylib/include