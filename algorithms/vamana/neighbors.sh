...
# ./neighbors -R 64 -L 128 -alpha 1.0 -data_type float -dist_func mips -base_path $Q/base.1B.fbin.crop_nb_1000000
...
# ./neighbors -R 64 -L 128 -alpha 1.0 -data_type float -two_pass 0 -dist_func mips -query_path $Q/base_rs_10000.fbin -gt_path $Q/text2image-base-10K-1M -res_path distribution_compare.csv -base_path $Q/base.1B.fbin.crop_nb_1000000
# ./neighbors -R 64 -L 128 -alpha 1.0 -data_type float -two_pass 0 -dist_func mips -query_path $Q/query_rs_10000_2.fbin -gt_path $Q/query-query-10K.fbin -res_path distribution_compare.csv -base_path $Q/query_crop_1000000.fbin
# ./neighbors -R 64 -L 128 -alpha 1.0 -data_type float -two_pass 0 -dist_func mips -query_path $Q/base_rs_10000.fbin -gt_path $Q/query-base-10K.fbin -res_path distribution_compare.csv -base_path $Q/query_crop_1000000.fbin
