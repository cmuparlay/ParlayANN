...
./neighbors -R 64 -L 128 -alpha 1.0 -data_type float -two_pass 0 -dist_func Euclidian -query_path $Q/query.public.10K.fbin -gt_path $Q/text2image-10K-1M -res_path test.csv -base_path $Q/base.1B.fbin.crop_nb_1000000
