...
# ./neighbors -R 64 -L 128 -alpha 1.0 -data_type float -dist_func Euclidian -sample_path $Q/query_rs_1000.fbin -query_path $Q/query.public.10K.fbin -gt_path $Q/text2image-10K-10M -res_path test.csv -base_path $Q/base.1B.fbin.crop_nb_10000000
