...
data_options = {
  ...
  "ssnpp-100M" : {"base": ssnpp+"/FB_ssnpp_database.u8bin.crop_nb_100000000", 
    ...
    "ssnpp-1B" : {"base": ssnpp+"/FB_ssnpp_database.u8bin", 
                "query": ssnpp+"/FB_ssnpp_public_queries.u8bin", 
                "data_type" : "uint8", 
                "dist_fn": "Euclidian",
                "radius": 96237,
                ...
                "quantize_mode": 0,
                "alpha": 1.10,
                "gt": ssnpp+"/FB_ssnpp_public_queries_1B_GT.rangeres",
                "graph":"/ssd0/range_search_indices/graph_1B"},
